...
def main():
    ...
    ap.add_argument("--out", default=None, help="Output .xlsx path (default: <Opponent>_<Week>_DefensiveIQ.xlsx)")
    ...
    base = (args.out or f"{args.opponent.replace(' ', '_')}_Week{args.week}_DefensiveIQ.xlsx")
